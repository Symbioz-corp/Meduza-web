...
export default function Signup() {
  ...
  return (
    <>
      <section className="w-full bg-slate-900 flex justify-center items-center">
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm  ">
              <div className="p-4 sm:p-7">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-gray-600 ">
                    ...
                    <a
                      ...
                      className="cursor-pointer text-blue-600 decoration-2 hover:underline font-medium"
                    >
                      Connectez-vous
                    </a>
                  </p>
                ...
                <div className="mt-5">
                  ...
                  <a
                    className="mt-4 w-full py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm"
                    href="#"
                  >
                    <svg
                      className="w-4 h-4 "
                    ...
                    <div className="grid gap-y-4">
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            id="fullname"
                            name="fullname"
                            className="py-3 px-4 block w-full border border-solid  border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500   "
                            required
                        ...
                        <p
                          ...
                          id="fullname-error"
                        >
                          Veuillez renseigner votre vrai nom
                        </p>
                      </div>
                      <div>
                        <label className="block text-sm mb-2 ">
                      ...
                      <div>
                        ...
                        <p
                          ...
                          id="password-error"
                        >
                          Votre mot de passe doit contenir au moin 8 caractères
                        </p>
                      </div>
