                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                    <div>
                        <div className="p-4 relative z-10 bg-white border rounded-xl md:p-10">
                            ...
                            <div className="text-sm text-gray-500">Tout ce dont vous aviez besoin pour tester et configurer.</div>

                            <div className="mt-5">
                                <span className="text-6xl font-bold text-gray-800 ">Gratuit</span>
                            </div>
                    ...
                    <div>
                        <div className="shadow-xl shadow-gray-200 p-5 relative z-10 bg-white border rounded-xl md:p-10">
                            <h3 className="text-xl font-bold text-gray-800 ">Utilisation réel</h3>
                            <div className="text-sm text-gray-500">Payez par utilisateur par mois!</div>
                            <span className="absolute top-0 right-0 rounded-tr-xl rounded-bl-xl text-xs font-medium bg-gray-800 text-white py-1.5 px-3 ">Le plus populaire</span>
                            ...
                            <div className="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
                                <div>
                                    <p className="text-sm text-gray-500">Payez par mobile monnaie.</p>
                                </div>

                                <div className="flex justify-end">
                                    <button type="button" className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm">Commencer</button>
                                </div>
                            </div>
                        </div>
                    </div>
